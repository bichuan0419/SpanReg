...
for i = 1:nrun
subplot(3,nrun,i)
plot(T2(1:100),IdealModel_weighted(1:100),'LineWidth',2,'color',[0,0,0])
hold on
plot(T2(1:100),DP_rec_vec(1:100,i),'LineWidth',2,'color',[0, 0, 1]);
hold off
...
plot(T2(1:100),IdealModel_weighted(1:100),'LineWidth',2,'color',[0,0,0])
hold on
plot(T2(1:100),F_rec_vec(1:100,i),'LineWidth',2,'color',[1, 0, 0]);
hold off
a = get(gca,'XTickLabel');  
set(gca,'XTickLabel',a,'fontsize',16)

subplot(3,nrun,2*nrun+i)
plot(TE,dat_noiseless,'LineWidth',2,'color',[0,0,0])
hold on
DP_rec_sig = A*DP_rec_vec(:,i);
F_rec_sig = A*F_rec_vec(:,i);
plot(TE,DP_rec_sig,':','LineWidth',2,'color',[0, 0, 1]);
plot(TE,F_rec_sig,'--','LineWidth',2,'color',[1, 0, 0]);
hold off
a = get(gca,'XTickLabel');  
set(gca,'XTickLabel',a,'fontsize',16)
end
